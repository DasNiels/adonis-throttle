 ...
 *     Edited by Niels Visbeek to support whitelisting certain IP addresses
 *
...
class ThrottleProvider extends ServiceProvider {
    register() {
        ...
        this.app.singleton( 'Adonis/Addons/Throttle', app => {
            ...
            const whitelist = Config.get( 'throttle.whitelist', [] );
            const driverInstance = ThrottleManager.makeDriverInstance( driver );
            return new Throttle( driverInstance, whitelist );
        } );
